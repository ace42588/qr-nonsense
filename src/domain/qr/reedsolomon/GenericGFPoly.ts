...
class GenericGFPoly {
  public field: GenericGF;
  public coefficients: Uint8ClampedArray;
  ...
  addOrSubtract(other: this): this {
    ...
    return new GenericGFPoly(this.field, sumDiff) as this;
  }

  multiply(scalar: number): this {
    if (scalar === 0) {
      return this.field.zero as this;
    }
    if (scalar === 1) {
      return this;
    }
    ...
    return new GenericGFPoly(this.field, product) as this;
  }

  multiplyPoly(other: this): this {
  ...
  multiplyByMonomial(degree: number, coefficient: number): this {
    if (degree < 0) {

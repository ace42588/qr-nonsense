...
export function getEncoder({ bitStream, type }) {
  //console.log("getEncoder", { bitStream, type });
  switch (type) {
    case "eci":
      return new EciEncoder(bitStream);
    case "numeric":
      return new NumericEncoder(bitStream);
    case "alphanumeric":
      return new AlphanumericEncoder(bitStream);
    case "byte":
      return new ByteEncoder(bitStream);
    case "kanji":
